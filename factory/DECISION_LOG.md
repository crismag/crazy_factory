...
| D-007 | 2026-09-16 | superseded | CF 2.0 centers on product intelligence + MCP, keeping the execution kernel | Correct as a later layer; the immediate failure is the missing closed execution loop, not missing UI or Director theater | [CF2_ARCHITECTURE.md](CF2_ARCHITECTURE.md) |
| D-008 | 2026-09-16 | accepted | P0 is a closed autonomous execution loop inside an isolated workbench | `advance` and `mission_loop` are one beat; `run` must keep evaluating and executing until COMPLETE, HUMAN_REQUIRED, or BUDGET. Safety floor stays. Product intelligence and multi-agent org are P2–P5. | [P0_AUTONOMOUS_LOOP.md](../docs/report/context/crazy-factory-2.0/P0_AUTONOMOUS_LOOP.md) |
