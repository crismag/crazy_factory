...
**Current focus:** Evaluator recognizes Codex as a coding capability
...
| CF2-P4-14 | DONE | Evaluator treats an available coding executor as another implementation beat | `coding_executor_available`; Codex + keys → MORE_WORK, none → RUNNABLE_PREVIEW |
